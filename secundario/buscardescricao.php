...
<!-- fim do preloader --> 
    ...
    <br><br>
        <div class="bg-inicio col-lg-4 offset-lg-4 text-center">
        <?php
            if ($erro == "error") {
                echo "<div class='alert alert-info show text-center' role='alert'>
                        <strong><h5>Nenhum produto encontrado</h5></strong>
                    </div>";
                $_SESSION['erro'] = 'corrigido';
            }
        ?>
            <form action="/secundario/dadosprodutodescricao.php" method="POST">
                <div class="inputBox">
                    ...
                    <br>
                    <input class="bgreen col-5" type="submit" name="submit" value="Procurar">
                </div>
            </form>
        </div>
    </div>
