...
<!-- fim do preloader --> 
    ...
    <div class="d-flex col-12">
        <div class="container d-inline-block col-3 offset-1">
            <a class="" href="../index.php">
                <img src="../fotos/atacadaologo.png" alt="logo do atacadão" width="250" height="120" class="">
            </a>
        </div>
        <div class='col-4'></div>
        <div class='d-inline-block col-3 text-center opa'>
        </div>
        <div class='col-1'></div>
    </div>
    <div class="bg text-center login">
        <?php
        if ($url == "error") {
            echo "<div class='alert alert-danger text-center' role='alert'>
                    <strong>Login inválido</strong>
                </div>";
            $_SESSION['url'] = 'corrigido';
        }
        ?>
        <h1 class="d-inline-block">Login </h1>
        <form action="/editor/testarLogin.php" method="POST">
            <div class="inputBox">
                <br>
            ...
            <input class="blogin" type="submit" name="submit" value="Confirmar">
            <br>
            <br>
            <a href="../index.php" class="blogin2">
                Cancelar
            </a>
