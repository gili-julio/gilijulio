...
<head>
    ...
    <title>Editando: <?php echo $produto_data['descricao']; ?></title>
    <style>
        .cimainicio {
...
<!-- fim do preloader --> 
    ...
    <div class="">
        ...
        <div class="container logo text-end col-12 d-flex">
            ...
            <div class="d-inline-block col-lg-9">
                <br><br>
                <br>
                <a href="../secundario/dadosprodutocodigodebarras.php" class="blogin2 d-inline-block">
                    Cancelar
                </a>
            </div>
        </div>
    ...
    <div class="bg text-center col-10 offset-1">
        <form action="/editor/verificareditarfotosproduto.php" method="POST" enctype="multipart/form-data">
            <div class='d-inline-block col-lg-4 homi'>
                ...
                <br>
                <?php
                echo "<img src='../fotos/produtos/$foto' class='' width='200' height='width'>";
                ?>
                <br><br>
                <label for="fotoproduto" class="labelfoto"><strong>Enviar Imagem</strong></label>
                <input class="" type="file" id="fotoproduto" name="fotoproduto" accept=".jpg,.gif,.png,.jpeg">
            <br><br>
            </div>
