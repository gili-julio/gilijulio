...
if(($_SESSION['usuario'] == 'avaria') && ($_SESSION['senha'] == 'avaria')){
    ...
    $sqlavaria = "SELECT * FROM avaria_padaria";
    ...
    if(isset($_POST['submit'])){
        ...
        if(!empty($_POST['codigobarras']) && !empty($_POST['destino']) && !empty($_POST['quantidade'])){
            
            $valordestino = $_POST['destino'];
            ...
            if($valordestino == "999"){
                ...
                switch($valordestino){
                    ...
                    $sqlteste = "SELECT * FROM avaria_padaria WHERE codigo_barras = '$barras'";
                    ...
                    if(mysqli_num_rows($resultteste) == 0){
                        ...
                        if(mysqli_num_rows($resultlimite) >= 43){
                            ...
                            $sqladd = "INSERT INTO avaria_padaria (codigo_barras, descricao, quantidade, destino) VALUES ('$barras', '$descricao', '$quantidade', '$destino')";
...
<!-- fim do preloader --> 
    ...
    <br><br>
        ...
        if ($erro == "limite") {
            echo "<div class='alert alert-info col-4 offset-4 alert-dismissible fade show text-center' role='alert'>
                    <strong><h3>Limite de linhas atingido</h3></strong>
                    <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                </div>";
        }
        if ($erro == "existe") {
    ...
    <div class="text-center container">
        <table class="table text-start">
                    <tbody class="">
                        <tr class="borda">
                            <form action="/avaria/avariaPadaria.php" method="POST">
                                <?php
                                    if($editar == 'nao'){
                                        echo "<th colspan='2'>
                        ...
                        <tr>
                            <?php 
                                if(mysqli_num_rows($resultavaria) == 0){
                                    ...
                                    echo "<th> <strong>Destino</strong> </th>";
                                    echo "<th> <a class='bred d-inline-block' href='excluirPadaria.php'>Limpar</a></th>";
                                    echo "</tr>";
                                    while($tabelaavaria = mysqli_fetch_assoc($resultavaria)){
                                        ...
                                        echo "<th class='text-center'>".$tabelaavaria['destino']."</th>";
                                        echo "<th class='text-center'>
                                        <a class='bblue d-inline-block' href='/avaria/excluirPadaria.php?editar=$barras'>
                                        <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-fill' viewBox='0 0 16 16'>
                                          <path d='M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708l-3-3zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207l6.5-6.5zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.499.499 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11l.178-.178z'/>
                                        </svg>
                                        </a>
                                        <a class='bred d-inline-block' href='/avaria/excluirPadaria.php?id=$barras'>
    ...
    <?php
        if(mysqli_num_rows($resultavaria) != 0){
            echo "<div class='text-center container'>
                <a href='/avaria/excel/gerarPadaria.php' class='bgreen d-inline-block'>Gerar Arquivo Excel</a>
            </div>";
        }
    ?>
    <br><br>
